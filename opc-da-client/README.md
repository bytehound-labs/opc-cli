...
- **Native Inventory Diagnostics**: Diagnostic builds can log timing boundaries around DA2 `BrowseOPCItemIDs` calls and `IEnumString::Next` batches to isolate native enumeration stalls.
